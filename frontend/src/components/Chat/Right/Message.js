    ...
    return (
      <div className="relative / flex justify-end w-full">
        <div className="relative / flex items-end gap-1 / max-w-[60%] / group">
          <div className="relative / flex-1 / border p-[2px] rounded-xl ">{message || "this is message this is message this is message this is message this is message this is message this is message "}</div>
    ...
    return (
      <div className="relative / flex w-full">
        <div className="relative / flex items-end gap-1 / max-w-[60%] / group ">
          ...
          <div className="relative / flex-1 / border p-[2px] rounded-xl ">this is message this is message this is message this is message this is message this is message this is message </div>
